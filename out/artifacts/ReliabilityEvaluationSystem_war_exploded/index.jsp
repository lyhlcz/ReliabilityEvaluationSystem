...
<head>
	...
	<script>
        ...
        post('model/loadData', {'sqlName': sqlName}, function (data) {
            alert("in2");
            tmp = document.getElementById('test');
            alert("out2");
            tmp.innerHTML = data;
            alert("out3");
        });
...
<body>
    <button id="test" type="button" onclick="data()">dddddddddddddddddddddddddddddddd</button>
		<!-- start: Header -->
	<div class="navbar">
